...
import {
  ...
  Root2,
  createPopperScope
} from "./chunk-VNC4YCXL.js";
import {
  createCollection,
  useDirection
} from "./chunk-D7XJY2O6.js";
import "./chunk-6OQW6HSA.js";
import {
  Combination_default,
  DismissableLayer,
  FocusScope,
  ...
  hideOthers,
  useFocusGuards
} from "./chunk-6WBDH46M.js";
import {
  useCallbackRef,
  useId
} from "./chunk-GMT7PJJG.js";
import {
  Presence
} from "./chunk-SYLOI3NI.js";
import {
  composeEventHandlers,
  createContextScope,
  useControllableState,
  useLayoutEffect2
} from "./chunk-4W4XKGIK.js";
import {
  Primitive
} from "./chunk-FHFMFT74.js";
import {
  createSlot,
  useComposedRefs
} from "./chunk-46VL3YHF.js";
import {
  require_react_dom
...
function SelectProvider(props) {
  ...
  const handleNativeOptionAdd = React2.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React2.useCallback((option) => {
  ...
  return (0, import_jsx_runtime2.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime2.jsx)(SelectProviderImpl, { scope: __scopeSelect, ...context, children: (0, import_jsx_runtime2.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime2.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime2.jsx)(React2.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }
);
...
var SelectPortal = (props) => {
  ...
  return (0, import_jsx_runtime2.jsx)(PortalProvider, { scope: props.__scopeSelect, forceMount, children: (0, import_jsx_runtime2.jsx)(Portal, { asChild: true, ...portalProps }) });
};
...
var SelectContent = React2.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => present ? (0, import_jsx_runtime2.jsx)(SelectContentImpl, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime2.jsx)(SelectContentFragment, { ...contentProps, fragment }) });
  }
);
SelectContent.displayName = CONTENT_NAME;
var SelectContentFragment = React2.forwardRef((props, forwardedRef) => {
  const { __scopeSelect, children, fragment } = props;
  if (!fragment) return null;
  return ReactDOM.createPortal(
    (0, import_jsx_runtime2.jsx)(SelectContentProvider, { scope: __scopeSelect, children: (0, import_jsx_runtime2.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime2.jsx)("div", { ref: forwardedRef, children }) }) }),
    fragment
  );
});
...
var SelectArrow = React2.forwardRef(
  (props, forwardedRef) => {
    ...
    return contentContext.position === "popper" ? (0, import_jsx_runtime2.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
  ...
  ({ __scopeSelect, ...props }, forwardedRef) => {
    ...
    return (0, import_jsx_runtime2.jsxs)(
      Primitive.select,
      {
        ...
        children: [
          shouldShowPlaceholder(value) && !hasEmptyValueOption ? (0, import_jsx_runtime2.jsx)("option", { value: "" }) : null,
